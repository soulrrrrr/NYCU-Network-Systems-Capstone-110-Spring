...
def config(hosts, switches, routers, DHCPServer):
    ...
    #hosts['h2'].cmd('ifconfig h2-eth0 put_your_config_here')
    ...
    routers['r1'].cmd('ifconfig r1-eth1 192.168.1.126/25') # 127-1
    routers['r1'].cmd('ifconfig r1-eth2 192.168.1.254/25') # 255-1
    ...
    routers['r4'].cmd('ifconfig r4-eth1 192.168.3.254/24') # 255-1
